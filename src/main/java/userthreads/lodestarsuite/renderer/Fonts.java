...
import userthreads.lodestarsuite.events.meteor.CustomFontChangedEvent;
import userthreads.lodestarsuite.gui.WidgetScreen;
import userthreads.lodestarsuite.renderer.text.CustomTextRenderer;
import userthreads.lodestarsuite.renderer.text.FontFace;
...
import userthreads.lodestarsuite.utils.render.FontUtils;
...
public class Fonts {
    ...
    public static void refresh() {
        ...
        LodestarSuite.LOG.info("Found {} font families.", FONT_FAMILIES.size());
    ...
    public static void load(FontFace fontFace) {
        ...
        try {
            ...
            LodestarSuite.EVENT_BUS.post(CustomFontChangedEvent.get());
        }
        catch (Exception e) {
            ...
            LodestarSuite.LOG.error("Failed to load font: {}", fontFace, e);
