...
import userthreads.lodestarsuite.gui.renderer.operations.TextOperation;
import userthreads.lodestarsuite.gui.renderer.packer.GuiTexture;
import userthreads.lodestarsuite.gui.renderer.packer.TexturePacker;
import userthreads.lodestarsuite.gui.widgets.WWidget;
import userthreads.lodestarsuite.renderer.Renderer2D;
import userthreads.lodestarsuite.renderer.Texture;
import userthreads.lodestarsuite.utils.PostInit;
import userthreads.lodestarsuite.utils.misc.Pool;
import userthreads.lodestarsuite.utils.render.RenderUtils;
...
import static userthreads.lodestarsuite.utils.Utils.getWindowHeight;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(LodestarSuite.identifier("textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(LodestarSuite.identifier("textures/icons/gui/triangle.png"));
        EDIT = addTexture(LodestarSuite.identifier("textures/icons/gui/edit.png"));
        RESET = addTexture(LodestarSuite.identifier("textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(LodestarSuite.identifier("textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(LodestarSuite.identifier("textures/icons/gui/favorite_yes.png"));

        COPY = addTexture(LodestarSuite.identifier("textures/icons/gui/copy.png"));
        PASTE = addTexture(LodestarSuite.identifier("textures/icons/gui/paste.png"));
