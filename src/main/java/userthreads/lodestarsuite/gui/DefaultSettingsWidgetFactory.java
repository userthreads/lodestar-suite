...
import userthreads.lodestarsuite.gui.screens.settings.*;
import userthreads.lodestarsuite.gui.themes.meteor.widgets.WMeteorLabel;
...
public class DefaultSettingsWidgetFactory extends SettingsWidgetFactory {
    ...
    public DefaultSettingsWidgetFactory(GuiTheme theme) {
        ...
        factories.put(EnumSetting.class, (table, setting) -> enumW(table, (EnumSetting<?>) setting));
