...
package userthreads.lodestarsuite.gui.widgets.containers;
...
import userthreads.lodestarsuite.gui.widgets.pressable.WTriangle;
...
public abstract class WWindow extends WVerticalList {
    ...
    protected void renderBlurBackdrop(GuiRenderer renderer) {
        ...
        if (theme instanceof userthreads.lodestarsuite.gui.themes.meteor.LodestarGuiTheme) {
            userthreads.lodestarsuite.gui.themes.meteor.LodestarGuiTheme lodestarTheme = 
