...
import userthreads.lodestarsuite.gui.DefaultSettingsWidgetFactory;
...
import userthreads.lodestarsuite.gui.themes.meteor.widgets.*;
import userthreads.lodestarsuite.gui.themes.meteor.widgets.input.WMeteorDropdown;
import userthreads.lodestarsuite.gui.themes.meteor.widgets.input.WMeteorSlider;
import userthreads.lodestarsuite.gui.themes.meteor.widgets.input.WMeteorTextBox;
import userthreads.lodestarsuite.gui.themes.meteor.widgets.pressable.*;
import userthreads.lodestarsuite.gui.utils.AlignmentX;
import userthreads.lodestarsuite.gui.utils.CharFilter;
import userthreads.lodestarsuite.gui.widgets.*;
...
import userthreads.lodestarsuite.gui.widgets.input.WSlider;
import userthreads.lodestarsuite.gui.widgets.input.WTextBox;
import userthreads.lodestarsuite.gui.widgets.pressable.*;
import userthreads.lodestarsuite.renderer.text.TextRenderer;
...
public class LodestarGuiTheme extends GuiTheme {
    ...
    public LodestarGuiTheme() {
        super("Lodestar");

        settingsFactory = new DefaultSettingsWidgetFactory(this);
    }
    
    public LodestarGuiTheme(String name) {
        super(name);
