...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = LodestarSuite.identifier("textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = LodestarSuite.identifier("textures/container-transparent.png");
    ...
    private void drawBackground(HudRenderer renderer, int x, int y, Color color) {
        ...
        switch (background.get()) {
            ...
            case None -> {} // No background rendering
        }
    }
