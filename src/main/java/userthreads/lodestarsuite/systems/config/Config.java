...
package userthreads.lodestarsuite.systems.config;
...
public class Config extends System<Config> {
    ...
    public final Setting<Boolean> titleScreenSplashes = sgVisual.add(new BoolSetting.Builder()
        ...
        .description("Show Lodestar splash texts on title screen")
        .defaultValue(true)
        .build()
    );
    ...
    public final Setting<Boolean> chatFeedback = sgChat.add(new BoolSetting.Builder()
        .name("chat-feedback")
        .description("Sends chat feedback when lodestar performs certain actions.")
        .defaultValue(true)
        .build()
    );
    ...
    public NbtCompound toTag() {
        ...
        tag.putString("version", LodestarSuite.VERSION.toString());
