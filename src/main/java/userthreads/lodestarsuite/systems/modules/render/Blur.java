...
import userthreads.lodestarsuite.mixininterface.IGpuTexture;
import userthreads.lodestarsuite.renderer.FullScreenRenderer;
...
public class Blur extends Module {
    ...
    public Blur() {
        ...
        LodestarSuite.EVENT_BUS.subscribe(new ConsumerListener<>(ResolutionChangedEvent.class, event -> {
            // Resize all fbos
        ...
        LodestarSuite.EVENT_BUS.subscribe(new ConsumerListener<>(RenderAfterWorldEvent.class, event -> onRenderAfterWorld()));
    }
