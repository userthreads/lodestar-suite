...
import userthreads.lodestarsuite.events.render.TooltipDataEvent;
import userthreads.lodestarsuite.gui.screens.ContainerInventoryScreen;
import userthreads.lodestarsuite.mixin.EntityAccessor;
import userthreads.lodestarsuite.mixin.EntityBucketItemAccessor;
...
import userthreads.lodestarsuite.utils.misc.ByteCountDataOutput;
...
import userthreads.lodestarsuite.utils.tooltip.*;
...
public class BetterTooltips extends Module {
    ...
    public void renderTooltipBlurBackdrop(double x, double y, double width, double height) {
        ...
        userthreads.lodestarsuite.gui.renderer.BlurRenderer.getInstance().renderSimpleBlurBackdrop(
            x, y, width, height,
