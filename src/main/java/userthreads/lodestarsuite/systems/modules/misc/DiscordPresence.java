...
import userthreads.lodestarsuite.gui.widgets.containers.WVerticalList;
...
public class DiscordPresence extends Module {
    ...
    public void onActivate() {
        ...
        String largeText = "Lodestar Suite " + LodestarSuite.VERSION;
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (Utils.canUpdate()) {
            ...
            if (!lastWasInMainMenu) {
                rpc.setDetails("Lodestar Suite " + (LodestarSuite.BUILD_NUMBER.isEmpty() ? LodestarSuite.VERSION : LodestarSuite.VERSION + " " + LodestarSuite.BUILD_NUMBER));
    ...
    public WWidget getWidget(GuiTheme theme) {
        ...
        help.action = () -> Util.getOperatingSystem().open("https://github.com/userthreads/lodestar-suite/wiki/Starscript");
