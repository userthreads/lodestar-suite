...
import userthreads.lodestarsuite.utils.player.FindItemResult;
import userthreads.lodestarsuite.utils.player.InvUtils;
import userthreads.lodestarsuite.utils.player.Rotations;
import userthreads.lodestarsuite.utils.player.SlotUtils;
...
public class BlockUtils {
    ...
    public static void init() {
        LodestarSuite.EVENT_BUS.subscribe(BlockUtils.class);
    }
    ...
    public static boolean breakBlock(BlockPos blockPos, boolean swing) {
        ...
        // InstantRebreak module removed - no instant rebreaking
