...
package userthreads.lodestarsuite.utils.tooltip;
...
public class ContainerTooltipComponent implements TooltipComponent, MeteorTooltipData {
    private static final Identifier TEXTURE_CONTAINER_BACKGROUND = LodestarSuite.identifier("textures/container.png");
