...
public class TimezoneModule extends Module {
    ...
    public void onActivate() {
        ...
        if (showSeasonalInfo.get()) {
            String halloweenStatus = meteordevelopment.meteorclient.systems.halloween.HalloweenMode.get().isActive() ? "Active" : "Inactive";
            String christmasStatus = meteordevelopment.meteorclient.systems.christmas.ChristmasMode.get().isActive() ? "Active" : "Inactive";
        ...
        if (showInternetSyncInfo.get() && meteordevelopment.meteorclient.systems.timezone.InternetTimeSync.get() != null) {
            String syncStatus = meteordevelopment.meteorclient.systems.timezone.InternetTimeSync.get().getSyncStatus();
